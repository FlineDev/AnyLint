...
public enum Lint {
  ...
  public static func checkFileContents(
    ...
    fatalError()  // TODO: [cg_2021-07-08] not yet implemented
  ...
  //      log.exit(fail: true)
  //    }
  //    else if failOnWarnings
  //      && Statistics.shared.violations(severity: .warning, excludeAutocorrected: targetIsXcode).isFilled
  //    {
  //      log.exit(fail: true)
  //    }
  //    else {
